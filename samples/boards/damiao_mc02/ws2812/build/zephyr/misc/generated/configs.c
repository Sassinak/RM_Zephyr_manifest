...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_STM32_DIGI_TEMP_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_ENGINEER_MANIFEST_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_ETL_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_DAMIAO_MC02, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_DAMIAO_MC02_STM32H723XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WS2812_STRIP_SPI_FORCE_NOCACHE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BMI08X_ACCEL_TRIGGER_GLOBAL_THREAD, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STM32_DIGI_TEMP, 1);
